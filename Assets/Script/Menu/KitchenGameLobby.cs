...
public class KitchenGameLobby : MonoBehaviour
{
    ...
    private async Task<Allocation> AllocateRelay()
    {
        ...
        catch (Exception e) { Debug.Log(e); return default; }
    }
    ...
    public async void CreateLobby(string lobbyName, bool isPrivate)
    {
        ...
        try
        {
            ...
            // MODIF: on s’assure que le NetworkManager est propre
    ...
    public async void QuickJoin()
    {
        ...
        catch (LobbyServiceException e) { Debug.Log(e); OnQuickJoinFailed?.Invoke(this, EventArgs.Empty); }
    }
    ...
    public async void JoinWithId(string lobbyID)
    {
        ...
        catch (LobbyServiceException e) { Debug.Log(e); OnJoinFailed?.Invoke(this, EventArgs.Empty); }
    }
    ...
    public async void DeletedLobby()
    {
        if (joinedLobby != null)
        {
            try
    ...
    public async void LeaveLobby()
    {
        if (joinedLobby != null)
        {
            try
            {
                ...
                // MODIF: reset complet du NetworkManager
                if (NetworkManager.Singleton.IsListening)
                    NetworkManager.Singleton.Shutdown();
            }
            catch (LobbyServiceException e) { Debug.Log(e); }
